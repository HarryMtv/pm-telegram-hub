...
The Subscriptions screen: create, list, and delete subscriptions to the user's
personal chat, choosing event types and container filters from a lazily-expanded
container tree.
